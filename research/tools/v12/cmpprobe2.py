...
for path in sys.argv[2:4]:
    ...
    def wrap(o, c=None):
        a = fn(o, c)
        if 16*24 <= o['step'] < 18*24 and a.get('market'):
            D.append(('m', o['step'], a.get('market'), round(o['farms'][o['player']]['money'])))
        if o['step'] % 24 == 22:
